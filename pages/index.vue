<template>
  ...
  <div >
        ...
        <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">Евгений Румянцев</span>
              <span class="block text-indigo-600 xl:inline">vue+nuxt.js</span>
            </h1>
            <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">Занимаюсь профессиональной разработкой сайтов и приложений </p>
            <p class="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">Отзывы </p>
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div class="rounded-md shadow">
                <a href="https://youdo.com/u5621184" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg">youdo</a>
              </div>
              <div class="mt-3 sm:mt-0 sm:ml-3">
                <a href="https://vk.com/rum44" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-100 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-200 md:py-4 md:px-10 md:text-lg">Vk</a>
              </div>
            </div>
          </div>
        </main>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src="https://sun1-87.userapi.com/impf/O31IBThvOqey0ENTydlHiHXwBHMIU-fp074ESA/WHLPFP60t64.jpg?size=1024x1024&quality=96&sign=0afa72ccf1cffe0e5eacab2b78d6937c&type=album" alt="">
    </div>
  </div>
  ...
  export default {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        hid: 'description',
        name: 'description',
        content: 'Главная страница сделаная на nuxt 3'
      }
    ],
